package org.tpsecurity.config;

import javax.sql.DataSource;

import javax.sql.DataSource;
import org.tpsecurity.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
		// Paramétrer le service pour trouver l'utilisateur dans la base de données.
		// et paramétrer le PassswordEncoder
